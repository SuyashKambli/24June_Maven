...
public class UtilityClass 
{
	...
	{
		FileInputStream file=new FileInputStream(System.getProperty("user.dir")+"\\TestData\\Automation.xlsx");
	...
	public static void captureSS(WebDriver driver,int TCID) throws IOException
	{
		...
		File dest=new File(System.getProperty("user.dir")+"\\FailedTCaseSS\\TestCaseID"+TCID+".jpg");
